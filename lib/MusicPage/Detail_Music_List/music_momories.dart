...
class SomeonePage extends StatefulWidget {
  const SomeonePage({Key? key}) : super(key: key);

  @override
  State<SomeonePage> createState() => _SomeonePageState();
}

class _SomeonePageState extends State<SomeonePage> {
  ...
  void initPlayer() async {
    await player.setSource(AssetSource("memories.mp3"));
