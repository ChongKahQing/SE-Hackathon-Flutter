...
class YummyPage extends StatefulWidget {
  const YummyPage({Key? key}) : super(key: key);

  @override
  State<YummyPage> createState() => _YummyPageState();
}

class _YummyPageState extends State<YummyPage> {
  ...
  void initPlayer() async {
    await player.setSource(AssetSource("yummy.mp3"));
